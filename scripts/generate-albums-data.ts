...
import type { AlbumEntry } from '../src/album.config';
import type { ExifData, PhotoItem, AlbumSummary, AlbumDetail } from '../src/types/album';

// Re-import config at runtime (tsx handles TS imports)
const { albumConfig } = await import('../src/album.config');
