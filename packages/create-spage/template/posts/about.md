...
categories: [General]
preview: About this blog and the spage system that powers it.
---

## About

This blog is powered by [spage](https://github.com/Suzichen/spage), a static blog system built with React, Vite, TypeScript, and a Rust build engine.
